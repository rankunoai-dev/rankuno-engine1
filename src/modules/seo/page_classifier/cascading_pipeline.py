...
def classify_page(
    ...
    *,
    ...
    return FullPageIntelligenceProfile(
        ...
        page_title_count=evidence.page_title_count,
        page_title_outside_head=evidence.page_title_outside_head,
        meta_description=evidence.meta_description,
        meta_description_count=evidence.meta_description_count,
        meta_description_outside_head=evidence.meta_description_outside_head,
        h1_text=evidence.h1_text,
